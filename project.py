...
def nextitem():
    ...
    try:
        ...
        messagebox.showinfo("Title", "SORRY!...RECORD NOT FOUND")
def previousitem():
        global var
        var=var-1
        f.seek(var)
...
def lastitem():
    ...
    try:
        ...
        messagebox.showinfo("Title", "SORRY!...PRODUCT NOT FOUND")
...
def clearitem():
    ...
    entry5.delete(0, END)
#fn1353
label0= Label(root,text="PHARMACY PRODUCTS MANAGEMENT SYSTEM ",bg="blue",fg="white",font=("Times", 30))
label1=Label(root,text="INPUT ITEM NAME",bg="navy blue",relief="ridge",fg="white",font=("Times", 12),width=25)
entry1=Entry(root , font=("Times", 12))
label2=Label(root, text="INPUT ITEM PRICE",bd="2",relief="ridge",height="1",bg="navy blue",fg="white", font=("Times", 12),width=25)
entry2= Entry(root, font=("Times", 12))
label3=Label(root, text="INPUT ITEM QUANTITY",bd="2",relief="ridge",bg="navy blue",fg="white", font=("Times", 12),width=25)
entry3= Entry(root, font=("Times", 12))
label4=Label(root, text="INPUT ITEM CATEGORY",bd="2",relief="ridge",bg="navy blue",fg="white", font=("Times", 12),width=25)
entry4= Entry(root, font=("Times", 12))
label5=Label(root, text="INPUT ITEM DISCOUNT",bg="navy blue",relief="ridge",fg="white", font=("Times", 12),width=25)
...
button3= Button(root, text="VIEW FIRST ITEM" , bg="blue", fg="white", width =20, font=("Times", 12),command=firstitem)
button4= Button(root, text="VIEW NEXT ITEM" , bg="navy blue", fg="white", width =20, font=("Times", 12), command=nextitem)
button5= Button(root, text="VIEW PREVIOUS ITEM", bg="grey", fg="white", width =20, font=("Times", 12),command=previousitem)
button6= Button(root, text="VIEW LAST ITEM", bg="yellow", fg="black", width =20, font=("Times", 12),command=lastitem)
button7= Button(root, text="UPDATE ITEM", bg="orange", fg="white", width =20, font=("Times", 12),command=updateitem)
button8= Button(root, text="SEARCH ITEM", bg="green", fg="white", width =20, font=("Times", 12),command=searchitem)
